...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO danakeluar (nominal, person, description, created) 
            VALUE ('$nominal', '$person', '$description', '$created')";

    $query = mysqli_query($conn, $sql);
    if ($query) {
        header('Location: ./read-infaq.php');
    } else {
        echo "gagal submit";
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-12">
                            <form action="" method="POST">
                                ...
                                <button type="submit" name="submit" class="btn btn-primary">Tambah Pengeluaran Dana</button>
                            </form>
                        </div>
                    </div>
