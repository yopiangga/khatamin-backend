...
if (isset($_POST['submit'])) {
    ...
    if (true) {
        ...
        $sqlUpdate = "UPDATE artikel SET title='$title', description='$description', url='$url', author='$author' WHERE id=$id";
...
<head>
    ...
    <title>Khatamin - Edit Artikel</title>
                        ...
                        <div class="col-lg-6 col-md-12">
                            <form action="" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea type="text" class="form-control" name="description"><?= $artikel['description'] ?></textarea>
                                </div>
                                <!-- <div class="form-group">
                                    <label>Gambar</label>
                                    <input type="file" class="form-control" name="image" value="<?= $artikel['img'] ?>">
                                </div> -->
                                <div class="form-group">
                                    <label>URL</label>
                                    <input type="text" class="form-control" name="url" value="<?= $artikel['url'] ?>">
                                </div>
                                <div class="form-group">
                                    <label>Author</label>
